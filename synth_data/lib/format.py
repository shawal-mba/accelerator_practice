"""Rich console output — merged from BigQuery and Teradata formatters."""
...
def table_list(database: str, tables: list[dict[str, str]], kind_key: str = "table_type") -> None:
    title_key_label = "Type" if kind_key == "table_type" else "Kind"
    table = Table(
    ...
    table.add_column(title_key_label, style=STYLE_DIM)
